...
namespace HuMengyang0130ERSWindowsFormsApp
{
    public partial class EmployeeRecordsForm : Form
    {
        ...
        private void PopulateTreeView()
        {
            ...
            XmlTextReader reader = new XmlTextReader("D:\\软件设计实例分析\\WorkSpace\\HuMengyang0130ERSWindowsFormsApp\\HuMengyang0130ERSWindowsFormsApp\\EmpRec.xml");
        ...
        protected void PopulateListView(TreeNode crrNode) {
            InitalizeListView();
            XmlTextReader listRead = new XmlTextReader("D:\\软件设计实例分析\\WorkSpace\\HuMengyang0130ERSWindowsFormsApp\\HuMengyang0130ERSWindowsFormsApp\\EmpRec.xml");
